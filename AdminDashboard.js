...
const AdminPage = () => {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
          ...
          <ListItem button component={Link} to="/admin/manage-gyms">
            <ListItemIcon>
              <FitnessCenterIcon />
            </ListItemIcon>
            <ListItemText primary="Manage Gyms" />
          </ListItem>
          <ListItem button component={Link} to="/admin/employee-management">
            <ListItemIcon>
              <GroupIcon />
            </ListItemIcon>
    ...
    sx={{
        ...
        height: 'calc(100vh - 64px)', // Adjust height (minus AppBar height)
...
>
    <Box
        component="img"
        src="/images/BNR-IMAGE.JPG" // Your actual image path
        ...
        sx={{
            ...
            objectFit: 'fit',
            transition: 'all 0.3s ease-in-out', // Optional transition for smooth scaling
        }}
    />
</Box>
        <Container>
